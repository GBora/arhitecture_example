...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"ml-5 p-3 dialog-message\">\n  {{ content }}\n</div>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"dialog-user-avatar\">\n  {{ user.firstName[0].toUpperCase() }} {{ user.lastName[0].toUpperCase() }}\n</div>\n");
...
const routes = [
    ...
    { path: 'conversation', component: _conversation_conversation_component__WEBPACK_IMPORTED_MODULE_5__["ConversationComponent"] }
];
...
/* harmony import */ var _conversation_conversation_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./conversation/conversation.component */ "./src/app/conversation/conversation.component.ts");
/* harmony import */ var _friend_search_friend_search_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./friend-search/friend-search.component */ "./src/app/friend-search/friend-search.component.ts");
/* harmony import */ var _message_thread_message_thread_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./message-thread/message-thread.component */ "./src/app/message-thread/message-thread.component.ts");
/* harmony import */ var _dialog_message_dialog_message_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./dialog-message/dialog-message.component */ "./src/app/dialog-message/dialog-message.component.ts");
/* harmony import */ var _dialog_user_avatar_dialog_user_avatar_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./dialog-user-avatar/dialog-user-avatar.component */ "./src/app/dialog-user-avatar/dialog-user-avatar.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _conversation_conversation_component__WEBPACK_IMPORTED_MODULE_12__["ConversationComponent"],
            _friend_search_friend_search_component__WEBPACK_IMPORTED_MODULE_13__["FriendSearchComponent"],
            _message_thread_message_thread_component__WEBPACK_IMPORTED_MODULE_14__["MessageThreadComponent"],
            _dialog_message_dialog_message_component__WEBPACK_IMPORTED_MODULE_15__["DialogMessageComponent"],
            _dialog_user_avatar_dialog_user_avatar_component__WEBPACK_IMPORTED_MODULE_16__["DialogUserAvatarComponent"]
        ],
        imports: [
...
let MessageThreadComponent = class MessageThreadComponent {
    ...
    ngOnInit() {
        this.messages = [];
        this.messageService.getConversation(this.userService.getCurrentUser(), this.friend.email).then((res) => {
            this.messages = res;
        });
    }
    reply(event) {
